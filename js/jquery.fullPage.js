    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        function bindEvents(){
            ...
            $document
				...
				//
				.on('click','#home-link', sectionBulletHandler)
        ...
        */
        function styleMenu(section, index){
			...
			//추가
			if(options.slidemenu && options.css3 && $(options.slidemenu).closest(WRAPPER_SEL).length){
                $(options.slidemenu).appendTo($body);
            }
			//추가
			if(options.category && options.css3 && $(options.category).closest(WRAPPER_SEL).length){
                $(options.category).appendTo($body);
            }
        }
        ...
        */
		...
		//추가
		function activateSlideMenuElement(name){
            if(options.slidemenu){
                $(options.slidemenu).find(ACTIVE_SEL).removeClass(ACTIVE);
                $(options.slidemenu).find('[data-slidemenuanchor="'+name+'"]').addClass(ACTIVE);
            }
        }
		//추가
		function activateCategoryElement(name){
            if(options.category){
                $(options.category).find(ACTIVE_SEL).removeClass(ACTIVE);
                $(options.category).find('[data-category="'+name+'"]').addClass(ACTIVE);
            }
        }
        ...
        */
        function activateMenuAndNav(anchor, index){
			...
			activateSlideMenuElement(anchor);//추가
			activateCategoryElement(anchor) //추가
